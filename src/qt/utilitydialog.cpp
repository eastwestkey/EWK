    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("EWK Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About EWK Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  ewk-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("EWK Core is shutting down...") + "<br /><br />" +
